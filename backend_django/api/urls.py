...
urlpatterns = [
    ...
    path('volume/upload-preregistered', volume_api.upload_preregistered_volume, name='upload_preregistered_volume'),
    path('volume/load-from-mrifile', volume_api.load_mrifile_as_preregistered, name='load_mrifile_as_preregistered'),
