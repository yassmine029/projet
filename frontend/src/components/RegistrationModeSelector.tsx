        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between mb-0.5">
              <span className={`text-sm font-bold ${selectedMode === mode.id ? 'text-slate-900' : 'text-slate-800'}`}>
                {mode.title}
              </span>
              {mode.recommended && (
            ...
            <p className="text-[10px] text-slate-600 font-semibold group-hover:text-slate-700 transition-colors">{mode.description}</p>
          </div>
