    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="space-y-12 text-slate-700 text-base leading-relaxed">
          {/* Intro */}
          <p>
            Cette Politique de Confidentialité décrit comment BrainCore (« nous », « notre » ou « BrainCore ») collecte, utilise, divulgue et protège les informations vous concernant lorsque vous utilisez la plateforme BrainCore (la « Plateforme »). Cette Politique s'applique à tous les utilisateurs de la Plateforme, notamment les professionnels de santé enregistrés et les chercheurs autorisés. Nous nous engageons à protéger votre vie privée et à traiter vos données personnelles conformément à la législation applicable en matière de protection des données, notamment le Règlement Général sur la Protection des Données (UE) 2016/679 (« RGPD ») et les lois nationales applicables en matière de protection des données.
          </p>
          ...
          <div>
            ...
            <p>
              BrainCore SAS (SIRET : 12345678901234), située à 123 Rue de la Médecine, 75001 Paris, France, est le responsable du traitement responsable du traitement de vos données personnelles en vertu du RGPD. Notre Délégué à la Protection des Données peut être contacté à <a href="mailto:dpo@braincore.com" className="text-blue-600 underline hover:text-blue-700">dpo@braincore.com</a>. Nous nous engageons à répondre à toutes les demandes d'exercice des droits des personnes concernées et aux demandes de renseignements relatifs à la confidentialité dans un délai de 72 heures ouvrables.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mb-4">
              BrainCore met en œuvre des mesures de sécurité technique et organisationnelle complètes pour protéger vos données personnelles contre l'accès non autorisé, la modification, la divulgation ou la destruction :
            </p>
            <div className="overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                <thead>
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="px-4 py-3 text-slate-600 border border-slate-300 align-top">E-mail <a href="mailto:privacy@braincore.com" className="text-blue-600 underline hover:text-blue-700">privacy@braincore.com</a></td>
                  </tr>
                  <tr>
                    ...
                    <td className="px-4 py-3 text-slate-600 border border-slate-300 align-top">Via les paramètres du compte ou par e-mail à <a href="mailto:privacy@braincore.com" className="text-blue-600 underline hover:text-blue-700">privacy@braincore.com</a></td>
                  </tr>
                  <tr>
          ...
          <div>
            ...
            <p>
              BrainCore utilise uniquement des cookies techniques strictement nécessaires pour maintenir votre session authentifiée et assurer la fonctionnalité de la plateforme. Nous n'utilisons pas de cookies publicitaires, de cookies d'analyse ou de technologies de suivi tiers. Tous les cookies de session sont chiffrés, ont les drapeaux sécurisé et HTTP-only activés et expirent à la fin de la session. Nous ne vendons, ne partageons et ne commercialisons pas les données de cookies avec un tiers.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Pour toute demande liée à la confidentialité ou pour exercer vos droits en vertu du RGPD, veuillez contacter notre Délégué à la Protection des Données à <a href="mailto:dpo@braincore.com" className="text-blue-600 underline hover:text-blue-700">dpo@braincore.com</a>. Nous nous engageons à répondre à toutes les demandes dans un délai de 72 heures ouvrables. Vous pouvez également contacter notre département juridique général à <a href="mailto:legal@braincore.com" className="text-blue-600 underline hover:text-blue-700">legal@braincore.com</a> pour les demandes non liées à la confidentialité.
            </p>
          </div>
        </div>
