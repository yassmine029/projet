      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="space-y-12 text-slate-700 text-base leading-relaxed">
          ...
          <div>
            ...
            <p className="mb-4">
              VisionMed est un logiciel d'aide à la décision clinique et ne constitue pas un dispositif médical au sens du Règlement (UE) 2017/745 concernant les dispositifs médicaux (MDR). Les masques de segmentation, les métriques de recalage et autres résultats générés par les modèles d'intelligence artificielle de VisionMed sont fournis uniquement à titre informatif et d'aide à la décision.
            </p>
            <p>
              Ces résultats ne constituent pas des diagnostics médicaux, des recommandations cliniques ou des prescriptions thérapeutiques. VisionMed décline expressément toute responsabilité en cas de décisions cliniques prises en fonction des résultats de la Plateforme. Le clinicien traitant conserve l'intégrité et l'exclusivité de la responsabilité concernant toutes les décisions diagnostiques et thérapeutiques prises en rapport avec les soins des patients. Les professionnels de santé utilisant VisionMed doivent vérifier indépendamment tous les résultats avant de prendre une décision clinique quelconque.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mb-4">
              Vous êtes responsable de la confidentialité de vos identifiants de compte, notamment votre adresse e-mail et votre mot de passe. Vous acceptez de notifier VisionMed immédiatement à security@visionmed.com dès que vous devenez conscient d'un accès non autorisé à votre compte ou de toute autre violation de sécurité. VisionMed ne sera pas responsable des pertes ou dommages résultant de votre défaut à maintenir la confidentialité de vos identifiants.
            </p>
            <p>
              Vous ne devez pas partager votre compte avec des tiers ou permettre à des tiers d'accéder à la Plateforme à l'aide de vos identifiants. Vous ne pouvez pas utiliser le compte d'un autre utilisateur ou faire une fausse déclaration concernant votre identité. VisionMed se réserve le droit de suspendre ou de résilier tout compte qu'elle soupçonne raisonnablement d'être compromis ou utilisé en violation de ces Conditions.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mb-4">
              Tous les éléments de VisionMed, y compris notamment les modèles d'intelligence artificielle, les algorithmes de segmentation, les pipelines de recalage, les interfaces utilisateur, le code logiciel, les bases de données, la documentation et les marques commerciales, sont la propriété exclusive de VisionMed et sont protégés par les lois de la propriété intellectuelle applicables et les traités internationaux. Rien dans ces Conditions ne peut être interprété comme vous accordant une licence ou le droit d'utiliser une propriété intellectuelle de VisionMed, sauf comme expressément autorisé ici.
            </p>
            <p>
              Vous ne pouvez pas reproduire, copier, modifier, créer des travaux dérivés à partir de, rétro-concevoir, décompiler ou désassembler aucun composant de la Plateforme. Vous ne pouvez pas extraire, scraper ou autrement collecter des données de la Plateforme à des fins commerciales sans autorisation écrite préalable de VisionMed. L'accès non autorisé ou l'utilisation de tout contenu protégé par la propriété intellectuelle constitue une violation de droits d'auteur et peut vous exposer à une responsabilité pénale et civile.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm font-mono text-slate-600 leading-relaxed">
              LA PLATEFORME EST FOURNIE « EN L'ÉTAT » ET « TEL QUE DISPONIBLE » SANS GARANTIES D'AUCUNE SORTE, EXPRESSES OU IMPLICITES. VISIONMED EXCLUT EXPRESSÉMENT TOUTES LES GARANTIES, Y COMPRIS NOTAMMENT LES GARANTIES IMPLICITES DE QUALITÉ MARCHANDE, D'ADÉQUATION À UN USAGE PARTICULIER ET D'ABSENCE DE CONTREFAÇON. VISIONMED NE GARANTIT PAS QUE LA PLATEFORME SERA ININTERROMPUE, EXEMPTE D'ERREURS OU EXEMPTE DE VIRUS OU D'AUTRES COMPOSANTS NUISIBLES.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm font-mono text-slate-600 leading-relaxed mb-4">
              DANS LA MESURE MAXIMALE AUTORISÉE PAR LA LOI APPLICABLE, VISIONMED NE SHALL PAS ÊTRE RESPONSABLE DE TOUS LES DOMMAGES INDIRECTS, ACCIDENTELS, SPÉCIAUX, CONSÉCUTIFS OU PUNITIFS, Y COMPRIS NOTAMMENT LA PERTE DE DONNÉES, LA PERTE DE PROFITS OU L'INTERRUPTION D'ACTIVITÉ, DÉCOULANT DE OU EN CONNEXION AVEC VOTRE UTILISATION DE LA PLATEFORME, MÊME SI VISIONMED A ÉTÉ AVISÉE DE LA POSSIBILITÉ DE TELS DOMMAGES.
            </p>
            <p>
              Certaines juridictions n'autorisent pas les limitations de responsabilité, cette limitation peut donc ne pas s'appliquer à vous. Dans ces cas, la responsabilité de VisionMed sera limitée dans la mesure autorisée par la loi applicable.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Ces Conditions sont régies et interprétées conformément à la loi française applicable et aux réglementations de l'Union Européenne régissant la protection des données et le commerce électronique. Tout différend découlant de ou en connexion avec ces Conditions sera soumis à la juridiction exclusive des tribunaux compétents de Paris, France. Vous et VisionMed acceptez tous deux de vous soumettre à la juridiction personnelle de ces tribunaux.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Si vous avez des questions concernant ces Conditions, veuillez nous contacter à : <a href="mailto:legal@visionmed.com" className="text-blue-600 underline hover:text-blue-700">legal@visionmed.com</a>
            </p>
          </div>
        </div>
